...
Этот проект применяет современные методы эконометрики для оценки причинного влияния миграции на доходы. Анализ включает несколько методологических подходов: от простой регрессии до обработки данных на основе сопоставления ковариат.
